...
def get_datasets(args):
    ...
    train_data = ActionSpotDataset(
        ...
        args.frame_dir,args.flow_dir, args.store_dir, args.store_mode, args.clip_len, dataset_len, **dataset_kwargs)
    train_data.print_info()

    val_data = ActionSpotDataset(
        classes, os.path.join('data', args.dataset, 'val.json'),
        args.frame_dir,args.flow_dir, args.store_dir, args.store_mode, args.clip_len, dataset_len // 4, **dataset_kwargs)
    val_data.print_info()     
    ...
    test_data = ActionSpotDataset(
        ...
        args.frame_dir,args.flow_dir, args.store_dir, args.store_mode, args.clip_len, None, pad_len = 0, **dataset_kwargs)
