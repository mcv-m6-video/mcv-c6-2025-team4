...
# Commenting out old get_lr_scheduler function as we're replacing it
...
def main(args):
    ...
    # Paths
    checkpoint_path = os.path.join(ckpt_dir, 'checkpoint_best.pt')
    ...
    if not args.only_test:
        ...
        # Use the improved scheduler instead of the old one
        ...
        if os.path.exists(checkpoint_path) and os.path.exists(loss_json_path):
            ...
            if loss_data:
                ...
                epoch = best_epoch + 1  # Resume from the next epoch
