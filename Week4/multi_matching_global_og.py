...
# =============================================================================
def associate_tracklets(tracklets_cam1, tracklets_cam2, H1, H2, ref_gps, min_time_gap=1, time_tol=10, spatial_tol=10):
    """
    Associate tracklets from two cameras considering time and space.
    """
    associations = []
...
if __name__ == "__main__":
    ...
    tracking_files = {cam: f"/home/toukapy/Dokumentuak/Master CV/C6/mcv-c6-2025-team4/Week4/results/s01_{cam}_roi.txt" for cam in cam_ids}
    calib_files = {cam: f"/home/toukapy/Dokumentuak/Master CV/C6/mcv-c6-2025-team4/data/aic19-track1-mtmc-train/train/S01/{cam}/calibration.txt" for cam in cam_ids}
    ...
    for cam in cam_ids:
        ...
        # If a special case exists (like "c015") adjust fps; otherwise, use default fps.
        if cam == "c015":
    ...
    # 🔹 Asignar Global IDs a los grupos que abarcan al menos 2 cámaras.
    ...
    out_dir = "Global_Tracking_Miren_S01_new"
