...
#from model.model_spotting_w7 import Model
from model.model_spotting_w7_v2 import Model
...
def update_args(args, config):
    ...
    args.downscale = config['downscale']
...
def main(args):
    ...
    if not args.only_test:
        ...
        for epoch in range(epoch, num_epochs):
            ...
            val_map, _ = evaluate(model, val_data, nms_window=5)
