...
def calculate_hota(idtp, idfp, idfn):
    ...
    """
    try:
        return idtp / (idtp + 0.5 * (idfp + idfn))
    except ZeroDivisionError:
        return 0.0
...
if __name__ == "__main__":
    gt_file = "data/ai_challenge_s03_c010-full_annotation.xml"  # Change this to your GT XML file path
    pred_file = "Week2/MOTS-train-1.txt"  # Change this to your predictions file
